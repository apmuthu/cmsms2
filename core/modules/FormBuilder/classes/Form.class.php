...
/* ]]> */
    ...
    if($this->Page > 1)
    {
      $smarty->assign('prev', '<input class="cms_submit fbsubmit_prev" name="' . $id . 'fbrp_prev" id="' . $id .
    ...
    if($this->Page < $formPageCount)
    {
      ...
      $smarty->assign('submit', '<input class="cms_submit fbsubmit_next" name="' . $id . 'fbrp_submit" id="' . $id .
    ...
    else
    {
      ...
      $smarty->assign('submit', '<input class="cms_submit fbsubmit" name="' . $id . 'fbrp_submit" id="' . $id .
